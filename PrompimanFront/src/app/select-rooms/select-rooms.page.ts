...
export class SelectRoomsPage implements OnInit {
  ...
  confirm() {
    ...
    this.api.settingAllRoom.haveBreakfast = true;
    this.api.settingAllRoom.haveAddBreakfast = false;
    this.api.settingAllRoom.addBreakfastCount = 0;
    this.api.settingAllRoom.haveExtraBed = false;
    this.api.settingAllRoom.extraBedCount = 0;
    this.api.settingAllRoom.discount = 0;
